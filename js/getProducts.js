...
export function createCard(name,price,image){
  ...
  product.innerHTML=` <div class="card_image_container">
              ...
              <div class="card-footer">
                ...
                <button class="card-button" data-button>
...
async function conexion(){
  ...
  products.forEach((item)=>{
    console.log(item.name,item.price,item.image)
    lista.appendChild(createCard(item.name,item.price,item.image))
  })
}
